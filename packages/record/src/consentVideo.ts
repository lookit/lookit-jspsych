...
const info = <const>{
  ...
  parameters: {
    ...
    datause: { type: ParameterType.HTML_STRING, default: "" },
    gdpr: { type: ParameterType.BOOL, default: false },
    gdpr_personal_data: { type: ParameterType.HTML_STRING, default: "" },
    gdpr_sensitive_data: { type: ParameterType.HTML_STRING, default: "" },
    ...
    payment: { type: ParameterType.HTML_STRING, default: undefined },
    private_level_only: { type: ParameterType.BOOL, default: false },
    procedures: { type: ParameterType.HTML_STRING, default: undefined },
    purpose: { type: ParameterType.HTML_STRING, default: undefined },
    research_rights_statement: {
      type: ParameterType.HTML_STRING,
      default: "",
    },
    risk_statement: { type: ParameterType.HTML_STRING, default: "" },
    voluntary_participation: {
      type: ParameterType.HTML_STRING,
      default: "",
    },
    purpose_header: { type: ParameterType.HTML_STRING, default: "" },
    procedures_header: { type: ParameterType.HTML_STRING, default: "" },
    participation_header: { type: ParameterType.STRING, default: "" },
    benefits_header: { type: ParameterType.HTML_STRING, default: "" },
    risk_header: { type: ParameterType.HTML_STRING, default: "" },
    summary_statement: { type: ParameterType.HTML_STRING, default: "" },
    additional_segments: {
